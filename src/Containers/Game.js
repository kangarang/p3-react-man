	...
	render() {
		...
		const styles = {
			...
			wrapper: {
                ...
                boxShadow: "0 0 5px 5px cornflowerblue",
                display: "flex",
                justifyContent: "center"
			},
		}
		return (
			<div onClick={this.handleClickInstructions} style={styles.container}>
				<div style={styles.wrapper}>
                    {this.state.letsPlay ? <TileContainer tiles={this.state.tiles}/> : <Instructions />}
				</div>
			</div>
		)
...
class Wrapper extends Component {
	...
	componentDidMount() {
		ReactDOM.render(
			<Game/>, document.getElementById('gameMount'))
	}
